...
/*
Escreva um programa que crie uma variável do tipo double e inicie essa variável
com o valor de 1. Dentro de um loop, aumente o valor dessa variável em 1%
(multiplicação por 1,01) cumulativamente a cada iteração. Quantas iterações
serão necessárias para que essa variável ultrapasse o valor de 100 mil?
